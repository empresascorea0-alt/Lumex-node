...
TEST (fork_cache, construction)
{
	...
	lumex::fork_cache_config cfg;
	lumex::fork_cache fork_cache{ cfg, system.stats };
	ASSERT_EQ (0, fork_cache.size ());
	ASSERT_FALSE (fork_cache.contains (lumex::qualified_root{}));
}
...
TEST (fork_cache, one)
{
	...
	auto block = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, lumex::dev::genesis->hash (), lumex::dev::genesis_key.pub, lumex::Klumex_ratio, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);
	lumex::qualified_root root = block->qualified_root ();
...
TEST (fork_cache, multiple_forks)
{
	...
	auto block1 = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, lumex::dev::genesis->hash (), lumex::dev::genesis_key.pub, lumex::Klumex_ratio, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);
	auto block2 = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, lumex::dev::genesis->hash (), lumex::dev::genesis_key.pub, lumex::Klumex_ratio * 2, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);
	auto block3 = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, lumex::dev::genesis->hash (), lumex::dev::genesis_key.pub, lumex::Klumex_ratio * 3, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);

	lumex::qualified_root root = block1->qualified_root ();
...
TEST (fork_cache, multiple_roots)
{
	...
	auto block1 = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, lumex::test::random_hash (), lumex::dev::genesis_key.pub, lumex::Klumex_ratio, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);

	lumex::keypair key2;
	auto block2 = std::make_shared<lumex::state_block> (key2.pub, lumex::test::random_hash (), key2.pub, lumex::Klumex_ratio, lumex::test::random_hash (), key2.prv, key2.pub, 0);

	lumex::keypair key3;
	auto block3 = std::make_shared<lumex::state_block> (key3.pub, lumex::test::random_hash (), key3.pub, lumex::Klumex_ratio, lumex::test::random_hash (), key3.prv, key3.pub, 0);

	lumex::qualified_root root1 = block1->qualified_root ();
	lumex::qualified_root root2 = block2->qualified_root ();
	lumex::qualified_root root3 = block3->qualified_root ();
...
TEST (fork_cache, duplicate_block)
{
	...
	ASSERT_EQ (1, system.stats.count (lumex::stat::type::fork_cache, lumex::stat::detail::insert));
...
TEST (fork_cache, complex_scenario)
{
	...
	auto const previous1 = lumex::test::random_hash ();
	auto block1a = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, previous1, lumex::dev::genesis_key.pub, lumex::Klumex_ratio, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);
	auto block1b = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, previous1, lumex::dev::genesis_key.pub, lumex::Klumex_ratio * 2, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);
	auto block1c = std::make_shared<lumex::state_block> (lumex::dev::genesis_key.pub, previous1, lumex::dev::genesis_key.pub, lumex::Klumex_ratio * 3, lumex::test::random_hash (), lumex::dev::genesis_key.prv, lumex::dev::genesis_key.pub, 0);

	lumex::qualified_root root1 = block1a->qualified_root ();

	// Create blocks for second root
	auto const previous2 = lumex::test::random_hash ();
	lumex::keypair key2;
	auto block2a = std::make_shared<lumex::state_block> (key2.pub, previous2, key2.pub, lumex::Klumex_ratio, lumex::test::random_hash (), key2.prv, key2.pub, 0);
	auto block2b = std::make_shared<lumex::state_block> (key2.pub, previous2, key2.pub, lumex::Klumex_ratio * 2, lumex::test::random_hash (), key2.prv, key2.pub, 0);

	lumex::qualified_root root2 = block2a->qualified_root ();

	// Create block for third root
	lumex::keypair key3;
	auto const previous3 = lumex::test::random_hash ();
	auto block3 = std::make_shared<lumex::state_block> (key3.pub, previous3, key3.pub, lumex::Klumex_ratio, lumex::test::random_hash (), key3.prv, key3.pub, 0);
...
TEST (fork_cache, nonexistent)
{
	...
	lumex::qualified_root nonexistent_root;
