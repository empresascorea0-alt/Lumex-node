...
{
	context context;
	lumex::unchecked_info info{ block () };
...
TEST (block_store, one_bootstrap)
{
	...
	auto block1 = builder
				  ...
				  .work (5)
				  .build ();
	unchecked.put (block1->hash (), lumex::unchecked_info{ block1 });
	auto check_block_is_listed = [&] (lumex::block_hash const & block_hash_a) {
	...
	std::vector<lumex::block_hash> dependencies;
	unchecked.for_each ([&dependencies] (lumex::unchecked_key const & key, lumex::unchecked_info const & info) {
...
TEST (unchecked, simple)
{
	...
	unchecked.put (block->previous (), lumex::unchecked_info (block));
	...
	unchecked.del (lumex::unchecked_key (block->previous (), block->hash ()));
...
TEST (unchecked, multiple)
{
	...
	unchecked.put (6, lumex::unchecked_info (block));
	auto check_block_is_listed = [&] (lumex::block_hash const & block_hash_a) {
		return unchecked.get (block_hash_a).size () > 0;
	};
...
TEST (unchecked, multiple_get)
{
	...
	unchecked.put (block1->previous (), lumex::unchecked_info (block1)); // unchecked1
	unchecked.put (block1->hash (), lumex::unchecked_info (block1)); // unchecked2
	unchecked.put (block2->previous (), lumex::unchecked_info (block2)); // unchecked3
	unchecked.put (block1->previous (), lumex::unchecked_info (block2)); // unchecked1
	unchecked.put (block1->hash (), lumex::unchecked_info (block2)); // unchecked2
	unchecked.put (block3->previous (), lumex::unchecked_info (block3));
	unchecked.put (block3->hash (), lumex::unchecked_info (block3)); // unchecked4
	unchecked.put (block1->previous (), lumex::unchecked_info (block3)); // unchecked1
	...
	std::vector<lumex::block_hash> unchecked1;
	...
	std::vector<lumex::block_hash> unchecked2;
	// Asserts the entries will be found for the provided key
