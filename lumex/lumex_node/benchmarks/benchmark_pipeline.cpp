...
public:
	pipeline_benchmark (std::shared_ptr<lumex::node> node_a, benchmark_config const & config_a);
...
pipeline_benchmark::pipeline_benchmark (std::shared_ptr<lumex::node> node_a, benchmark_config const & config_a) :
...
void pipeline_benchmark::run_iteration (std::deque<std::shared_ptr<lumex::block>> & blocks)
{
