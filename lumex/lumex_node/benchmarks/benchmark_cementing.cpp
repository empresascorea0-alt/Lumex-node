...
private:
	...
	lumex::locked<std::unordered_map<lumex::block_hash, std::chrono::steady_clock::time_point>> pending_cementing;
...
public:
	cementing_benchmark (std::shared_ptr<lumex::node> node_a, benchmark_config const & config_a);
...
cementing_benchmark::cementing_benchmark (std::shared_ptr<lumex::node> node_a, benchmark_config const & config_a) :
...
void cementing_benchmark::run_iteration (std::deque<std::shared_ptr<lumex::block>> & blocks)
{
