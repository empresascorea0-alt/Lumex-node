...
void lumex::active_elections_index::insert (std::shared_ptr<lumex::election> const & election, lumex::election_behavior behavior, lumex::bucket_index bucket, lumex::priority_timestamp priority)
{
...
bool lumex::active_elections_index::erase (std::shared_ptr<lumex::election> const & election)
{
...
void lumex::active_elections_index::update (std::shared_ptr<lumex::election> const & election, lumex::election_behavior behavior)
{
	auto & index = entries.get<tag_ptr> ();
...
bool lumex::active_elections_index::exists (lumex::qualified_root const & root) const
{
	return entries.get<tag_root> ().contains (root);
}

bool lumex::active_elections_index::exists (std::shared_ptr<lumex::election> const & election) const
{
	return entries.get<tag_ptr> ().contains (election);
}

std::shared_ptr<lumex::election> lumex::active_elections_index::election (lumex::qualified_root const & root) const
{
...
auto lumex::active_elections_index::info (std::shared_ptr<lumex::election> const & election) const -> std::optional<entry>
{
...
auto lumex::active_elections_index::list () const -> std::deque<std::shared_ptr<lumex::election>>
{
	auto r = entries.get<tag_sequenced> () | std::views::transform ([] (auto const & entry) { return entry.election; });
	return { r.begin (), r.end () };
}

bool lumex::active_elections_index::empty () const
{
	return entries.empty ();
}

size_t lumex::active_elections_index::size () const
{
	return entries.size ();
}

size_t lumex::active_elections_index::size (lumex::election_behavior behavior) const
{
...
size_t lumex::active_elections_index::size (lumex::election_behavior behavior, lumex::bucket_index bucket) const
{
...
auto lumex::active_elections_index::last (lumex::election_behavior behavior, lumex::bucket_index bucket) const -> priority_result
{
	...
	return { nullptr, std::numeric_limits<lumex::priority_timestamp>::max () };
}

auto lumex::active_elections_index::list (std::chrono::steady_clock::time_point cutoff, std::chrono::steady_clock::time_point now) -> std::deque<std::shared_ptr<lumex::election>>
{
...
bool lumex::active_elections_index::trigger (std::shared_ptr<lumex::election> const & election)
{
	auto & index = entries.get<tag_ptr> ();
...
bool lumex::active_elections_index::any (std::chrono::steady_clock::time_point cutoff) const
{
	auto & index = entries.get<tag_timestamp> ();
	auto it = index.begin ();
...
void lumex::active_elections_index::clear ()
{
	entries.clear ();
