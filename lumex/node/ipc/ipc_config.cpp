...
lumex::ipc::ipc_config_tcp_socket::ipc_config_tcp_socket (lumex::network_constants const & network_constants) :
	network_constants{ network_constants },
	port{ network_constants.default_ipc_port }
{
}

lumex::error lumex::ipc::ipc_config::serialize_toml (lumex::tomlconfig & toml) const
{
	...
	lumex::tomlconfig flatbuffers_l;
...
lumex::error lumex::ipc::ipc_config::deserialize_toml (lumex::tomlconfig & toml)
{
