...
namespace ipc
{
	 ...
	 * @throws Methods of this class throw lumex::error on failure.
	...
	public:
		 ...
		 */
		flatbuffers_handler (lumex::node & node_a, lumex::ipc::ipc_server & ipc_server_a, std::shared_ptr<lumex::ipc::subscriber> const & subscriber_a, lumex::ipc::ipc_config const & ipc_config_a);
		 ...
		 */
		static std::shared_ptr<flatbuffers::Parser> make_flatbuffers_parser (lumex::ipc::ipc_config const & ipc_config_a);
	...
	private:
		...
		lumex::ipc::ipc_config const & ipc_config;
	};
}
}
