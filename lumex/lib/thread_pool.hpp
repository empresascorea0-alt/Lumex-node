...
public:
	...
	thread_pool (unsigned num_threads, lumex::thread_role::name thread_name, bool auto_start = false) :
	...
	void set_thread_names ()
	{
		for (auto i = 0u; i < num_threads; ++i)
		{
			boost::asio::post (*thread_pool_impl, [this] () {
				lumex::thread_role::set (thread_name);
...
private:
	...
	lumex::thread_role::name const thread_name;
