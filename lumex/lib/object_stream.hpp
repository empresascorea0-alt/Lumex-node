...
public:
	...
	// Handle `.write_range ("name", container, [] (auto const & entry, lumex::object_stream &) { ... })`
	...
	// Handle `.write_range ("name", container, [] (auto const & entry, lumex::array_stream &) { ... })`
	template <class Container, class Writer>
...
public:
	...
	// Handle `.write (container, [] (auto const & entry, lumex::object_stream &) { ... })`
	template <class Container, class Writer>
		requires (std::is_invocable_v<Writer, typename Container::value_type, object_stream &>)
	...
	// Handle `.write_range (container, [] (auto const & entry, lumex::array_stream &) { ... })`
	template <class Container, class Writer>
		requires (std::is_invocable_v<Writer, typename Container::value_type, array_stream &>)
	void write (Container const & container, Writer writer)
	{
...
public:
	...
	// Handle `.write_range (container, [] (auto const & entry, lumex::object_stream &) { ... })`
	template <class Container, class Writer>
		requires (std::is_invocable_v<Writer, typename Container::value_type, object_stream &>)
...
template <class Container>
inline void lumex::object_stream::write_range (std::string_view name, Container const & container)
{
...
template <class Container>
inline void lumex::root_object_stream::write_range (Container const & container)
{
