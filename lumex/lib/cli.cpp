...
std::vector<std::string> lumex::config_overrides (std::vector<config_key_value_pair> const & key_value_pairs_a)
{
...
std::istream & lumex::operator>> (std::istream & is, lumex::config_key_value_pair & into)
{
	char ch;
	while (is >> ch && ch != '=')
	{
