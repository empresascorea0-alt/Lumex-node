...
lumex::timer<UNIT, CLOCK>::timer (lumex::timer_state state_a, std::string const & description_a) :
	desc (description_a)
{
	if (state_a == lumex::timer_state::started)
	{
		start ();
	}
}
...
template <typename UNIT, typename CLOCK>
lumex::timer<UNIT, CLOCK>::timer (std::string const & description_a) :
	desc (description_a)
{
}

template <typename UNIT, typename CLOCK>
lumex::timer<UNIT, CLOCK>::timer (std::string const & description_a, lumex::timer<UNIT, CLOCK> * parent_a) :
	parent (parent_a),
	desc (description_a)
{
}
...
template <typename UNIT, typename CLOCK>
lumex::timer<UNIT, CLOCK> & lumex::timer<UNIT, CLOCK>::set_minimum (UNIT minimum_a)
{
	minimum = minimum_a;
	return *this;
}
...
template <typename UNIT, typename CLOCK>
lumex::timer<UNIT, CLOCK> & lumex::timer<UNIT, CLOCK>::child (std::string const & description_a)
{
...
template <typename UNIT, typename CLOCK>
lumex::timer<UNIT, CLOCK> & lumex::timer<UNIT, CLOCK>::start_child (std::string const & description_a)
{
...
template <typename UNIT, typename CLOCK>
void lumex::timer<UNIT, CLOCK>::start ()
{
	debug_assert (state == lumex::timer_state::stopped);
	state = lumex::timer_state::started;
	begin = CLOCK::now ();
}

template <typename UNIT, typename CLOCK>
UNIT lumex::timer<UNIT, CLOCK>::restart ()
{
	auto current = ticks;
	state = lumex::timer_state::started;
	begin = CLOCK::now ();
...
template <typename UNIT, typename CLOCK>
UNIT lumex::timer<UNIT, CLOCK>::pause ()
{
	++measurements;
	return stop ();
}
...
template <typename UNIT, typename CLOCK>
void lumex::timer<UNIT, CLOCK>::update_ticks ()
{
	auto end = CLOCK::now ();
...
template <typename UNIT, typename CLOCK>
UNIT lumex::timer<UNIT, CLOCK>::stop ()
{
	debug_assert (state == lumex::timer_state::started);
	state = lumex::timer_state::stopped;
...
template <typename UNIT, typename CLOCK>
UNIT lumex::timer<UNIT, CLOCK>::value ()
{
	if (state != lumex::timer_state::stopped)
	{
		update_ticks ();
	}
	return ticks;
...
template <typename UNIT, typename CLOCK>
UNIT lumex::timer<UNIT, CLOCK>::since_start () const
{
	auto end = CLOCK::now ();
...
template <typename UNIT, typename CLOCK>
bool lumex::timer<UNIT, CLOCK>::after_deadline (UNIT duration_a)
{
	auto end = CLOCK::now ();
...
template <typename UNIT, typename CLOCK>
bool lumex::timer<UNIT, CLOCK>::before_deadline (UNIT duration_a)
{
	auto end = CLOCK::now ();
	return std::chrono::duration_cast<UNIT> (end - begin) < duration_a;
}
...
template <typename UNIT, typename CLOCK>
void lumex::timer<UNIT, CLOCK>::stop (std::ostream & stream_a)
{
	stop ();
	print (stream_a);
}
...
template <typename UNIT, typename CLOCK>
void lumex::timer<UNIT, CLOCK>::stop (std::string & output_a)
{
...
template <typename UNIT, typename CLOCK>
void lumex::timer<UNIT, CLOCK>::print (std::ostream & stream_a)
{
	if (ticks >= minimum)
	{
...
template <typename UNIT, typename CLOCK>
std::string lumex::timer<UNIT, CLOCK>::unit () const
{
	return typed_unit<UNIT> ();
}

template <typename UNIT, typename CLOCK>
lumex::timer_state lumex::timer<UNIT, CLOCK>::current_state () const
{
	return state;
}
