...
class jsonconfig : public lumex::configbase
{
public:
	jsonconfig ();
	jsonconfig (boost::property_tree::ptree & tree_a, std::shared_ptr<lumex::error> const & error_a = nullptr);
	...
	jsonconfig & put_child (std::string const & key_a, lumex::jsonconfig & conf_a);
	jsonconfig & replace_child (std::string const & key_a, lumex::jsonconfig & conf_a);
