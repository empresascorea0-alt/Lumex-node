...
namespace ipc
{
	/** Produces Lumex API compliant Flatbuffers from objects and builders */
	...
	public:
		...
		{
			lumex::ipc::flatbuffer_producer producer;
		...
		auto make_envelope (flatbuffers::Offset<T> obj)
		{
			...
			lumexapi::EnvelopeBuilder envelope_builder (*fbb);
			...
			envelope_builder.add_message_type (lumexapi::MessageTraits<T>::enum_value);
