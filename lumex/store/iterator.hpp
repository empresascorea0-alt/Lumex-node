...
private:
	...
	lumex::store::transaction const * txn;
...
public:
	iterator (lumex::store::transaction const & txn, lmdb::iterator && internals);
	iterator (lumex::store::transaction const & txn, rocksdb::iterator && internals);
	~iterator ();
